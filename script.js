...
const operationalDisplay = document.querySelector("[data-operation]");
...
document.addEventListener("click", (e) => {
  if (e.target.matches("[data-all-clear]")) calculator.clear();
  ...
  if (e.target.matches("[data-equals]")) calculator.evaluate();
});
